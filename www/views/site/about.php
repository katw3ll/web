...
<section>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h1 class="css_head">Информация о магазине</h4>

                <br/>

                <h2 class="css_head2">Подзаголовок 2 </h2>

                <p class="css_text">Phasellus iaculis purus elementum felis varius, vel viverra massa 
